              ...
              product.images.map((thumb, index) => (
                ...
                >
                  <div class="border  border border-dark p-1 rounded thumbnail-box">
                    <LazyLoadImage
                      class="thumbnail-img"
                      // src={index === 0 ? generatePublicUrl(product.images[0].filename) : generatePublicUrl(thumb.filename)}
                      src={generatePublicUrl(thumb.filename)}
                      alt="thumbnail"
                    />
                  </div>
                </Link>
      ...
      <div className="row">
        ...
        <div className="col-9">
          <div className="d-none d-lg-block">
            {(product.category && product.category.name === "Mobile Phones") ||
            (product.category && product.category.name === "Tablets") ? (
              <>
                {/* {product.condition === "Brand New" ? (
                  <img
                    style={styles2}
              ...
              <div className="ml-0 pl-0 pt-2 ">{renderImage()}</div>
            )}
          </div>
          ...
          <div class="d-lg-none">
            <button
              type="button"
              className="mb-3 btn btn-product-call float-right"
            >
