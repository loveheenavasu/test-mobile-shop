...
function Autocomplete(props) {
	...
	const handleEnter = () => {
		history.push('/suggestions', { query: searchQuery });
	};
    ...
    useEffect(() => {
        ...
        const search = autocomplete({
            ...
            // debug: false,
            openOnFocus: true,
            placeholder: 'Search Smartphones, TVs, Speakers, MacBooks',
            renderer: { createElement, Fragment },
            render({ children }, root) {
                render(children, root);
            },
            ...props,
            // detachedMediaQuery: 'none', //To always turn off detached mode, pass 'none'
            onStateChange({ state }) {
                ...
                console.log("SEARCH STATE : ", state.query);
            },
        });
        return () => {
            search.destroy();
